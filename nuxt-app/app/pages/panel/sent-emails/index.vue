<template>
  ...
  <div class="p-6">
    <div class="mb-6">
      <h1 class="text-2xl font-bold text-gray-900">Отправленные Email</h1>
    </div>
      ...
      <div class="flex items-center space-x-4">
        <div class="relative flex-1 max-w-md">
          <input
            v-model="searchQuery"
            type="text"
            placeholder="Поиск по теме, содержимому или email..."
...
const fetchMessages = async () => {
  try {
    loading.value = true
    const response = await $fetch('/api/panel/sent-emails', {
      query: {
